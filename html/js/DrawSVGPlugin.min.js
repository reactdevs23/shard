!(function(e, t) {
    ...
    function v(e) {
        ...
        var t,
            ...
            g = 1;
        s(e) &&
            ((g = e.getScreenCTM()), (c = P(g.a * g.a + g.b * g.b)), (g = P(g.d * g.d + g.c * g.c)));
        try {
            n = e.getBBox();
        } catch (e) {
        ...
        if (
            ((n && (y || m)) ||
                ...
                ((y = o(e, M[l][0])),
                    ...
                    "line" === l &&
                    ((p = o(e, "x1")), (x = o(e, "y1")), (y = Math.abs(y - p)), (m = Math.abs(m - x)))),
                "path" === l)
        )
            (a = u.strokeDasharray),
    ...
    function w(e, t) {
        ...
        return (
            o < 0 && (o = r.indexOf(" ")),
            t < (r = o < 0 ? t : n(r.substr(0, o)) || 1e-5) && (r = t), [Math.max(0, -i), Math.max(0, r - i)]
        );
    }
                ...
                if (o) {
                    for (
                        ...
                        ((s = n / t._length),
                            ...
                            (t._offsetPT.s *= s),
                            (t._offsetPT.c *= s),
                            t._dashPT ? ((t._dashPT.s *= s), (t._dashPT.c *= s)) : (t._dash *= s)); o;
